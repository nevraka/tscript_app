const Header = () => {
  return (
    <div className="flex sm:ml-6 ">
      ...
      <img
        className="h-full content-center block h-6 w-8  pt-10 h-auto w-100px "
        src="https://www.monologuestories.com/wp-content/uploads/2020/05/monologue-stories-logo.jpg"
        alt="avatar"
      ></img>
    </div>
  );
